...
function cargarDisfraz(idItem) {
    $.ajax({
        dataType: 'json',
        url: "https://g98419ecafb8e98-db202110061042.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/costume/costume/" + idItem,
        type: 'GET',
...
function cargarCliente(idItem) {
    $.ajax({
        dataType: 'json',
        url: "https://g98419ecafb8e98-db202110061042.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/client/client/" + idItem,
        type: 'GET',
        success: function (response) {
            var item = response.items[0];
...
function cargarMensaje(idItem) {
    $.ajax({
        dataType: 'json',
        url: "https://g98419ecafb8e98-db202110061042.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/message/message/" + idItem,
        type: 'GET',
        success: function (response) {
            var item = response.items[0];
...
function consultarId() {
    ...
    $.ajax(
        { //al link le agregamos / y + el codigo
            url: "https://g98419ecafb8e98-db202110061042.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/costume/costume/" + codigo,
            type: "GET",
            dataType: "json",
            success: function (json) {
                $("#idDivConsulta").empty();
